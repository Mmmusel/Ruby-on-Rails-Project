class OrderitemsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @orderitem.save
        format.html { redirect_to orderitem_url(@orderitem), notice: "Orderitem was successfully created." }
  ...
  def update
    respond_to do |format|
      if @orderitem.update(orderitem_params)
        format.html { redirect_to carts_url, notice: "Orderitem was successfully updated." }
  ...
  private
    ...
    def orderitem_params
      params.require(:orderitem).permit(:order_id, :title, :price, :num, :image)
    end
end
