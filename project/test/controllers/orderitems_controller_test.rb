...
class OrderitemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create orderitem" do
    assert_difference("Orderitem.count") do
      post orderitems_url, params: { orderitem: { image: @orderitem.image, num: @orderitem.num, order_id: @orderitem.order_id, price: @orderitem.price, title: @orderitem.title } }
    end
  ...
  test "should update orderitem" do
    patch orderitem_url(@orderitem), params: { orderitem: { image: @orderitem.image, num: @orderitem.num, order_id: @orderitem.order_id, price: @orderitem.price, title: @orderitem.title } }
